...
const Page = async ({
  ...
  return (
    <div className="overflow-x-hidden">
      <div className="absolute dark:hidden inset-0 -z-10 h-full overflow-hidden w-full bg-white bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px]">
